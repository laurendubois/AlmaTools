...
# The CSV here refers to a sheet where MMS, Holding ID, and Physical Item ID are known
df = pd.read_csv("View For Holdings.csv", dtype=str)
print(df)
print(len(df))
...
# If Physical Item ID is unknown you can replace the Holdings ID with "ALL/items" to get a list.
# for i in range(0, len(df)):
